...
void TEST_CASES(ll testCase)
{
    ...
    ll count_up = 0, count_down = 0, count_left = 0, count_right = 0;
    ...
    ll max_count = max({count_up, count_down, count_left, count_right});
    ...
    else if (max_count == count_up)
    {
        cout << count_up << en
             << Sx << " " << Sy + 1 << en;
    }
    else if (max_count == count_left)
    {
        cout << count_left << en
             << Sx - 1 << " " << Sy << en;
    }
